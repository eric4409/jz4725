...
#ifdef JZ4740_LYRA
#define SPEN	(32*2+22)       //LCD_CS
#define SPCK	(32*2+23)       //LCD_SCL
#define SPDA	(32*1+17)       //LCD_SDA
#define LCD_RET (32*1+18)       //use for lcd reset
#else
...
do {                                                     \
	__gpio_as_pwm(4); \
        ...
        __tcu_set_full_data(PWM_CHN,__cpm_get_extalclk()/200+1);           \
