...
//int IS_WRITE_PCM;
static inline void actual_delay_msec(long delay_val);

#define SLOW_ANTI_POP 1
//#define FAST_ANTI_POP 1
//#define NEW_ANTI_POP 1

static inline void i2s_codec_clear(void)
{
        REG_ICDC_CDCCR1 = 0x021b2302;
}

static inline void i2s_codec_reset(void)
{
    REG_ICDC_CDCCR1 |= 1;
    mdelay(1);
...
#if SLOW_ANTI_POP
static inline void i2s_codec_init(void)
{
...
#endif
static inline void i2s_codec_set_mic(int v) /* 0 <= v <= 100 */
{
	v = v & 0xff;
	if(v < 0)
		v = 0;
...
static inline void i2s_codec_set_bass(int v) /* 0 <= v <= 100 */
{
	v = v & 0xff;
	if(v < 0)
		v = 0;
...
static inline void i2s_codec_set_mute(int v) /* 0 <= v <= 100 */
{
	REG_ICDC_CDCCR1 = ((REG_ICDC_CDCCR1 & ~(0x1 << 14)) | (v<<14));
}
static inline void i2s_codec_set_volume(int v) /* 0 <= v <= 100 */
{
	codec_volume = v;
	REG_ICDC_CDCCR2 = ((REG_ICDC_CDCCR2 & ~(0x3)) | codec_volume);
}
static inline u16 i2s_codec_get_bass(void)
{
	u16 val;
	int ret;
...
static inline u16 i2s_codec_get_mic(void)
{
	u16 val;
	int ret;
...
static inline u16 i2s_codec_get_volume(void)
{
	u16 val;
	int ret;
...
static inline void i2s_codec_set_channel(u16 ch)
{
//	i2s_codec_write(I2S_KEYCLICK_CONTROL, 0x4415);
}

static inline void i2s_codec_set_samplerate(int rate)
{
...
#if SLOW_ANTI_POP
static inline void HP_turn_on(void)
{ 
        //see 1.3.4.1
...
#if NEW_ANTI_POP
static  inline void HP_turn_off(void)
{
	REG_AIC_DR = 0x1;
	REG_AIC_DR = 0x1;
	REG_AIC_DR = 0x1;
...
static inline void in_codec_app1(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app2(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app3(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app4(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app5(void)
{
	/* wait to be test */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app6(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app7(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app8(void)
{
	/* test is wrong */
	if(HP_on_off_flag == 1) {
		HP_on_off_flag = 0;
...
static inline void in_codec_app9(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app10(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app11(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app12(void)
{
	/* test is OK */
...
static  inline void in_codec_app13(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app14(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app15(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
...
static inline void in_codec_app16(void)
{
	/* test is wrong */
	if(HP_on_off_flag == 1) {
		HP_on_off_flag = 0;
...
static inline void in_codec_app17(void)
{
	/* test is OK */
	if(HP_on_off_flag == 0) {
		HP_on_off_flag = 1;
