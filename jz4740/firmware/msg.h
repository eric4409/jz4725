...
#define MSG_TYPE_TIMER_500MS    (1<<11)
#define MSG_TYPE_TIMER_BASEMS     (1<<15)
#define MSG_TYPE_SWITCH           (1<<16)
...
#define News_Battery        56
#define News_Reset_Options  57
