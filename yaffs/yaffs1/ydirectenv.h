...
#else
#define YMALLOC(x) alloc(x)
#define YFREE(x)   deAlloc(x)
#endif
...
#define YAFFS_TRACE_WRITE               0x10000
#define YAFFS_TRACE_NANDACCESS		0x20000
#define YAFFS_TRACE_DELETION		0x40000
