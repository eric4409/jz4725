...
#define mALLOc          _mem_malloc
#define mEMALIGn        _memalign
#define rEALLOc         _mem_reallocm
#define vALLOc          valloc
#define pvALLOc         pvalloc
#define mALLINFo        mallinfo
#define mALLOPt         mallopt
...
Void_t* mem_malloc(size_t);
void    mem_free(Void_t*);
//Void_t* mem_allign(Void_t*, size_t);
Void_t* mem_realloc(Void_t*, size_t);
