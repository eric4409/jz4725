...
typedef struct __tag_FS_FILE__{
        unsigned int _flags;
        unsigned char *_base;
        unsigned char *_p;
        unsigned char _data[FS_FBUF_LEN];
	FS_size_t (*_read)(void *pData, FS_size_t Size, FS_size_t N, struct __tag_FS_FILE__ *pFile);
	FS_size_t (*_write)(const void *pData, FS_size_t Size, FS_size_t N, struct __tag_FS_FILE__ *pFile);
	...
	FS_i32 _w;                 /* size of _data free space     */
